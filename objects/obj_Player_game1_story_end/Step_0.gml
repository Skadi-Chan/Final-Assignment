...
if collision_circle(x,y, 70,obj_npc3, false, false){
	...
	if  keyboard_check_pressed(vk_space){ 
		instance_destroy(obj_npc3_talk4)
		instance_destroy(obj_npc3_talk5)
		instance_destroy(obj_npc3_talk6)
		
		if talked1 = false and talked2 = false and talked3=false{
			instance_create_depth(x-340, y-240, -4000, obj_npc3_talk4)
			...
			instance_create_depth(x-340, y-240, -4000, obj_npc3_talk5)
			audio_play_sound(snd_talk,1,0)
			talked2 = true
		}
		
		else if talked1 = true and talked2 = true and talked3 = false{
			instance_create_depth(x-340, y-240, -5000, obj_npc3_talk6)
			audio_play_sound(snd_talk,1,0)
			talked3 = true
		}
